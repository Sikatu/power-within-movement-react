...
test('Phase 30 readiness becomes ready only with complete production-shaped configuration', () => {
...
test('Phase 30 readiness blocks missing schema and delivery providers without exposing secrets', () => {
  const snapshot = buildReleaseReadinessSnapshot({
...
test('Phase 30 readiness summary treats review as not automated-ready', () => {
