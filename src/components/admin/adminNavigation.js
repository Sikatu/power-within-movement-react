...
export const studioGroups = [
  ...
  },
  {
    ...
    items: [
      { to: '/admin/brief', label: 'Today in The Studio', module: 'dashboard' },
      { to: '/admin/week', label: 'Studio Week Planner', module: 'dashboard' },
      { to: '/admin/capacity', label: 'Studio Capacity', module: 'dashboard' },
      { to: '/admin/momentum', label: 'Client Momentum', module: 'clients' },
      { to: '/admin/coverage', label: 'Coverage & Handoffs', module: 'clients' },
      { to: '/admin/readiness', label: 'Session Readiness', module: 'sessions' },
      { to: '/admin/follow-through', label: 'Session Follow-Through', module: 'sessions' },
      { to: '/admin/attention', label: 'Attention Queue', module: 'clients' },
      { to: '/admin/activity', label: 'Studio Activity', module: 'dashboard' },
      { to: '/admin/audit-log', label: 'Activity Journal', module: 'audit' },
    ],
  },
]
