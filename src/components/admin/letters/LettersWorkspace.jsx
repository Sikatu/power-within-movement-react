  ...
  return (
    <section className="pwc-letters28-builder">
      ...
      <div className="pwc-letters28-builder-grid">
        ...
        <main className="pwc-letters28-canvas-column"><label className="pwc-letters28-preview-text"><span>Inbox preview text</span><input value={working.preview_text || ''} onChange={(event) => onUpdateLetter({ preview_text: event.target.value })} placeholder="A short line shown beside the subject" /></label><LetterCanvas design={working.design} selectedBlockId={selectedBlockId} onSelect={onSelectBlock} onMove={onMoveBlock} previewMode={previewMode} readOnly={readOnly} /></main>
