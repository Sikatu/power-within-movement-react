...
const pathways = [
  { number: '01', title: 'Teen Confidence Support', text: 'For teen girls who need steadier language, confidence support, and a place to be seen clearly.', action: 'Start a conversation', to: '/contact?interest=teens' },
  ...
  return (
    <main id="main-content" className="teen-page">
      ...
      <section className="teen-closing section-shell">
        ...
        <div>
          <Link className="button button-primary" to="/contact?interest=teens">Ask About Teen Support</Link>
