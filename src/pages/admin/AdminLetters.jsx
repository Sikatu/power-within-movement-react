...
export default function AdminLetters() {
  ...
  async function handleRecoveryComplete(response) {
    const details = [
  ...
  function handleRecoveryError(recoveryError) {
    setError(recoveryError.message || 'Scheduled broadcasts could not be checked.')
  }
    ...
    <AdminFrame>
      ...
      >
        ...
        {activeTab === 'letters' && working && <LetterEditor
          ...
          formatDate={formatDate}
        />}
        {activeTab === 'delivery' && <DeliveryQueue audience={audience} deliveryView={deliveryView} setDeliveryView={setDeliveryView} scheduled={scheduledBroadcasts} sent={sentBroadcasts} adminUser={adminUser} capabilities={capabilities} onRecoveryComplete={handleRecoveryComplete} onRecoveryError={handleRecoveryError} renderBroadcastList={renderBroadcastList} />}
