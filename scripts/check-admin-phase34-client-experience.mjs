...
const requiredTokens = [
  ...
  [encouragementsSource, "searchParams.get('view') === 'compose' ? 'compose' : 'library'", 'Client Messages library-first mode with direct compose access'],
  [encouragementsSource, 'aria-label="Client message workspace"', 'Client Messages workspace tabs'],
