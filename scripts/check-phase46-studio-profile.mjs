...
const requirements = [
  ...
  [routes, "requireRole(['developer', 'owner', 'admin'])", 'owner-level profile permissions'],
  [routes, "router.get('/studio-profile', requireStudioProfileManager", 'authenticated profile reading'],
  [routes, "router.patch('/studio-profile', requireStudioProfileManager", 'authenticated profile saving'],
